...
def calculate_optimal_temperature(data_path: str, final_path:str,  years: np.ndarray, step: int):
    ...
    Parameters:
    - data_path: str, path to the directory containing the ERA5 data files at
    daily temporal resolution and spatial resolution of 0.25 degrees 
    (720x1440 dimension). Files are renamed following the format: 'era5_t2m_mean_day_<year>.nc'
    - final_path: str, path to the directory where the results will be saved.
