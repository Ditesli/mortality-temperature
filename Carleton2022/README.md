...
Some of the advantages of employing this methodology in an Integrated Assessment Model include: the disagregation of mortality between three age groups: young (0-4 years), older (5-64 years), and oldest (+65 years). This disaggregation allows to analyze the larger impact on the elderly; as the income per capita an climatology are included as covariates of the equation; letting the coefficients to evolve in time allows to have adaptation in which individuals are assumed to take individual actions, constrained to their income, to have a lesser mortality risk.
